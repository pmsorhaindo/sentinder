...
var Card = React.createClass({
  ...
  render: function() {
    ...
    return (
        ...
        <h1>Sentinder</h1>
        <p>From {this.props.pov}'s point of view is this tweet:</p>
...
var Tinderable = React.createClass({
  ...
  removeCard: function(side, cardId) {
    ...
    if (this.state.cards.length < 3) {
      this.props.actions.requestCard();
    }
  },
  ...
  render: function() {
    ...
    return (
        <div>
        <div className={classesAlertLeft}>Negative</div>
        <div className={classesAlertRight}>Positive</div>
        <div id="cards">
        {cards}
        </div>
        </div>
